...
class HomePageState extends State<HomePage> {
  final List<BankCardModel> cards = [
    BankCardModel('images/bg_blue_card.png', 'Da Antonio',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_blue_circle_card.png', 'Da Antonio',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_purple_card.png', 'Da Antonio',
        '4221 5168 7464 2283', '08/20', 10000000),
    BankCardModel('images/bg_red_card.png', 'Da Antonio',
        '4221 5168 7464 2283', '08/20', 10000000),
  ];
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
              ...
              child: Text('Mes comptes bancaires')),
          Container(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 8.0),
                          child: Text('Gaz', style: TextStyle(fontSize: 12.0)),
                        )
                      ],
                    ),
                  ),
